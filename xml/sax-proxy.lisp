...
(defmacro define-sax-proxy-method (name (&rest args))
...
(define-sax-proxy-method fxml.sax:start-document ())
(define-sax-proxy-method fxml.sax:start-element (uri lname qname attributes))
(define-sax-proxy-method fxml.sax:start-prefix-mapping (prefix uri))
(define-sax-proxy-method fxml.sax:characters (data))
(define-sax-proxy-method fxml.sax:unescaped (data))
(define-sax-proxy-method fxml.sax:processing-instruction (target data))
(define-sax-proxy-method fxml.sax:end-prefix-mapping (prefix))
(define-sax-proxy-method fxml.sax:end-element (namespace-uri local-name qname))
(define-sax-proxy-method fxml.sax:end-document ())
(define-sax-proxy-method fxml.sax:comment (data))
(define-sax-proxy-method fxml.sax:start-cdata ())
(define-sax-proxy-method fxml.sax:end-cdata ())
(define-sax-proxy-method fxml.sax:start-dtd (name public-id system-id))
(define-sax-proxy-method fxml.sax:end-dtd ())
(define-sax-proxy-method fxml.sax:start-internal-subset ())
(define-sax-proxy-method fxml.sax:end-internal-subset ())
(define-sax-proxy-method fxml.sax:unparsed-entity-declaration (name pub sys not))
(define-sax-proxy-method fxml.sax:external-entity-declaration (kind name pub sys))
(define-sax-proxy-method fxml.sax:internal-entity-declaration (kind name value))
(define-sax-proxy-method fxml.sax:notation-declaration (name public-id system-id))
(define-sax-proxy-method fxml.sax:element-declaration (name model))
(define-sax-proxy-method fxml.sax:attribute-declaration (elt attr type default))
(define-sax-proxy-method fxml.sax:entity-resolver (resolver))
(define-sax-proxy-method fxml.sax::dtd (dtd))
